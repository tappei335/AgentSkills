...
```sh
node ~/.claude/skills/site-design-recreator/scripts/compare_screenshots.mjs \
...
```sh
node ~/.claude/skills/site-design-recreator/scripts/audit_image_usage.mjs .
```
...
node ~/.claude/skills/site-design-recreator/scripts/audit_image_usage.mjs . > .design-process/asset-audit.json
```
